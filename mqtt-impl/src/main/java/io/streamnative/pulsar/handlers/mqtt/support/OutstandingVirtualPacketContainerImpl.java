 ...
 */
public class OutstandingVirtualPacketContainerImpl implements OutstandingVirtualPacketContainer {
    
    ConcurrentHashMap<Integer, OutstandingVirtualPacket> packets = new ConcurrentHashMap<>();
    
    @Override
    public void add(OutstandingVirtualPacket packet) {
        packets.put(packet.getPacketId(), packet);
    }
    
    @Override
    public OutstandingVirtualPacket remove(int packetId) {
        return packets.remove(packetId);
    }
    
    @Override
    public OutstandingVirtualPacket getPacket(int packetId) {
